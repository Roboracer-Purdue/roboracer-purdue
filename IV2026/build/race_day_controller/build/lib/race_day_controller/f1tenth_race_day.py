...
package_path = get_package_share_directory("race_day_controller")
...
class F1TenthRaceDayNode(Node):
    ...
    def declare_all_params(self):
        params = [
            ...
            ("frenet_max_offset", 0.20),
            ("frenet_num_offsets", 3),
            ("frenet_horizon", 2.5),
            ("frenet_step", 0.20),
            ("path_corridor_width", 0.25),
            ("offset_change_rate", 0.55),

            ("opponent_detect_distance", 1.4),
